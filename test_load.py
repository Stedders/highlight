...
def test_load_tf():
    ...
    assert site == json.load(open('test_results/test_load_tf.json', 'r'))


def test_load_ft():
    site = load.get_global(False, True)
    assert site == json.load(open('test_results/test_load_ft.json', 'r'))


def test_load_tt():
    site = load.get_global(True, True)
    assert site == json.load(open('test_results/test_load_tt.json', 'r'))
